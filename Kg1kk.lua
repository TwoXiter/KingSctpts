...
MakeNotifi({
  Title = "King Scripts Hub",
  Text = "This Script Was Developed By Pequenino Xiter (xiterdev7#0000)",
  Time = 5
})
...
local Paragraph = AddParagraph(Main, {"Versão 1.8.7", ""})

AddButton(Main, {
  Name = "Link For Discord King",
  Callback = function()
    setclipboard ("https://discord.gg/invite/2Day56M4Xs")
  end
})

AddButton(Main, {
  Name = "Link For YouTube King",
  Callback = function()
    setclipboard ("https://youtube.com/@king.of.scripts?si=ms4zSyx_VrXlMPxa")
  end
})

AddButton(Main, {
  Name = "Link For Discord Mink",
  Callback = function()
    setclipboard ("https://discord.com/invite/WHM6vde8BP")
  end
})

local Main = MakeTab({Name = "Fe Scripts"})

AddButton(Main, {
  Name = "Xiter Hub (The Best)",
  Callback = function()
    loadstring(game:HttpGet("https://rentry.co/XiterWare/raw"))()
  end
})
...
local Main = MakeTab({Name = "Blox Fruits"})
...
AddButton(Main, {
  Name = "Gomu Hub 2.0",
  Callback = function()
   loadstring(game:HttpGet('https://raw.githubusercontent.com/pokelok/Gomu-2.0/main/2'))()
    end
})
...
AddButton(Main, {
  Name = "Sukuna Hub",
  Callback = function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Script-Blox/Script/main/Sukuna-Hub'))()
  end
})
...
AddButton(Main, {
  Name = "Meliodas Hub",
  Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/pokelok/suna/main/meliodas"))()
  end
})
...
AddButton(Main, {
  Name = "Novo 2024",
  Callback = function()
    loadstring(game:HttpGet("https://pastebin.com/raw/AYmqzFAk"))()
    end
})
...
AddButton(Main, {
  Name = "Suggestions For Discord King Please",
  Callback = function()
...
local Main = MakeTab({Name = "Demon Piece"})
...
local Main = MakeTab({Name = "Era Dos Grimoires"})
...
AddButton(Main, {
  Name = "Era Hub",
  Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/LOLking123456/Grimoires/main/Era"))()
  end
})  
